...
python .\DANN_CORR_AE.py ^
    ...
    --work_dir unlabeled\231116_231117\0.1_2_2
python .\DANN_CORR_AE.py ^
...
class AutoencoderFeatureExtractor(nn.Module):
    def __init__(self):
        ...
        self.encoder_fc1 = nn.Linear(7, 8)
        self.encoder_fc2 = nn.Linear(8, 16)
        self.decoder_fc1 = nn.Linear(16, 8)
        self.decoder_fc2 = nn.Linear(8, 7)
