...
# 處理 label0611.csv
label_df0611 = pd.read_csv('labels200219.csv', header=0)
...
# 處理 label0219.csv
label_df0219 = pd.read_csv('labels190611.csv', header=0)
...
# 將處理後的資料存為 csv 檔案
df0611.to_csv('data200219.csv', index=False)
df1009.to_csv('data191009.csv', index=False)
df0219.to_csv('data190611.csv', index=False)

for df, name in zip([df0611, df1009, df0219], ['200219', '191009', '190611']):
