...
# 處理 label0219.csv
label_df0219 = pd.read_csv('labels_2020-02-19.csv', header=0)
...
df0219.to_csv('data_2020-02-19.csv', index=False)
...
for site_survey in site_surveys:
    if(site_survey == '2019-02-19' or site_survey == '2019-03-25' or site_survey == '2020-02-19' or site_survey == '2021-04-23'): # number of RP different, don't use them
        continue
    ...
    missing_aps = [ap for ap in df0219.columns if ap not in df.columns]
...
# for df, name in zip([df0219, df1009, df0219], ['190219', '191009', '200219']):
